...
\section{Vocabulary}
\marginnote{\textbf{Study:} pgs.~141--152 (skim for the various plankton types; see side note below for planktonic taxa we will cover in more detail), 152--154, 163, 200–203 (!), 204 (Fig.~9.8), 209–  (primary productivity).}
...
\item
  What is plankton?\marginnote{The important planktonic taxa we will cover in this course are diatoms and dinoflagellates (phytoplankton), and copepods (zooplankton.)} Describe the many ways in which planktonic organisms
