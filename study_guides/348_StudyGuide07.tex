...
\item
  What are the stages\marginnote{Levinton (your textbook author) gives somewhat different names for each stage:\\
    scavenger stage,\\ enriched sediment stage,\\ sulfide stage, and\\ “reef” stage.\\[\baselineskip]
    \noindent The stage names I gave in lecture were defined by Smith and Baco (2003), which is cited by Levinton. 
    I don't know why Levinton changed the names. Study the names I gave in lecture.} of succession that have been described for whale
